    ...
    if request.method == 'GET':
        ...
        if request.POST['password1'] == request.POST['password2']:
            try:
               ...
               return render(request, 'signup.html', {'form': UserCreationForm, 'error': "Username alrea dy exists"})
    ...
    if request.method == 'GET':
        ...
        try:
            ...
            return redirect('tasks')
               ...
               return render(request, 'create_task.html', {'form': TaskForm, 'error': "Please provide a valid task"})
